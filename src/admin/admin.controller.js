...
// async function DanhSachMonHocTrongLop(req, res) { 
//     let result = await adminModel.DanhSachMonHocTrongLop();
//     if(result.statusCode === 200) {
//         let html = pug.renderFile('public/admin/DanhSachMonHocTrongLop.pug',{
...
// async function ThemMonHocVaoLop(req, res) {
//     try {

//         const data = req.body;
//         if(!data.MaMH || !data.MaLop || !data.MaGV || !data.MoTa || !data.HeSo || !data.TenMH)
//             return res
//                 .status(400)
//                 .send({
//                     statusCode: 400,
...
//             let result_class = await adminModel.getClass(data.MaLop)
//             if (result_class.statusCode == 200 ){
//                 let result_teacher = await userModel.getUser(data.MaGV)
//                 if(result_teacher.statusCode == 200){
//                     let SQLQuery = `insert into MONHOC (MaMH,TenMH,MoTa,HeSo) values ( '${data.MaMH}',N'${data.TenMH}',N'${data.MoTa}','${data.HeSo}')`;
//                     let result_subject = await adminModel.TruyVan("Admin", SQLQuery);
//                     console.log(result_subject);
//                     if (result_subject.statusCode == 200){
//                         const result = await adminModel.ThemMonHocVaoLop(data.MaLop,data.MaMH,data.MaGV);
//                         console.log(result);
//                         return res
//                             .status(200)
//                             .send({
...
//                                 alert: "Thêm môn học vào lớp thành công",
//                                 redirect: '/admin/ThemMonHoc'
//                             });
//                     }else{
//                         return res
...
//                                 statusCode: 400,
//                                 message: 'Thêm môn học vào lớp không thành công',
//                                 alert: "Thêm môn học vào lớp không thành công",
//                                 redirect: '/admin/ThemMonHoc'
//                             });
//                     }
//                 }else{
...
// exports.DanhSachMonHocTrongLop = DanhSachMonHocTrongLop;
